...
Original file is located at
    https://colab.research.google.com/github/Paradorn657/recurrent_nearal/blob/master/MIT_Music_Generation.ipynb
...
# seq_length คือ window_size
pred = model(x)
print("Input shape:      ", x.shape, " # (batch_size, sequence_length)")
print("Prediction shape: ", pred.shape, "# (batch_size, sequence_length, vocab_size)")
print("Prediction shape: ", y.shape, "# (batch_size, sequence_length, vocab_size)")
